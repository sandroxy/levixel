...
dcloud_sdk_root="${DCLOUD_IOS_SDK_ROOT:-${repo_root}/../dcloud/5.07/SDK}"
...
if [[ ! -f "${dcloud_sdk_root}/SDK/inc/DCUni/DCUniModule.h" ]]; then
  echo "DCloud iOS SDK not found: ${dcloud_sdk_root}" >&2
  exit 1
fi
